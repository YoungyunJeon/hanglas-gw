...
# 1번
customersList = [
    "Hanglass",["#019 HANGLAS_CPU, Memory_1", "#019 HANGLAS_CPU, Memory_2","#019 HANGLAS_CPU, Memory_3"]
]
...
#1번인지 2번인지 수정
fname = Lsa[0]+"_cpu_mem_max_worktime_"+ datetime.now().strftime("%Y%m%d") + '_v1.xlsx'
